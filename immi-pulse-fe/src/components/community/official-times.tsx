...
import { deltaVsOfficial, formatDays } from "@/lib/community/format";
          ...
          {isLoading ? (
            ...
            <>
              {stats.map((v) => {
                ...
                // The comparison is only shown when the community's figure is one we
                // are willing to publish. A "12 days faster" built on four
                // timelines is not a finding, it is noise wearing a badge.
                const delta = community.sufficient
                  ? deltaVsOfficial(community.p50, v.official.p50_days)
                  : null;
                ...
                return (
                  ...
                  >
                    ...
                    <div className="min-w-0">
                      ...
                      {/*
                        Provenance travels with the community's figure wherever it
                    ...
                    {delta ? (
                      ...
                      <span className="c-mono whitespace-nowrap text-[10.5px] text-ink-soft/60">
                        {community.provenance.total > 0
                          ? `${community.provenance.total} so far · need ${community.min_sample}`
                          : "no community data"}
                      </span>
                    )}
                  </div>
