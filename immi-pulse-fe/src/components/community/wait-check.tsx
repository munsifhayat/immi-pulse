...
/**
 * The composition of a community figure, rendered beside it.
 *
 ...
 */
function ProvenanceLine({ community }: { community: CommunityDurationStats }) {
  if (!community.provenance_note) return null;
  return (
    <p className="mt-2 text-[11.5px] leading-relaxed text-ink-soft">
      {community.provenance_note}
      {community.pending > 0 && (
        <>
          {" "}
          {community.pending.toLocaleString()}{" "}
          {community.pending === 1 ? "person is" : "people are"} still waiting — their
        ...
        {!ready ? (
          ...
          <>
            ...
            {/*
              ...
              the official figure alone is an unchecked claim, and the community's
            ...
            <div className="mt-4 border-t border-hair pt-3.5">
              {result.basis === "official" ? (
                <>
                  ...
                  <p className="mt-2 text-[11.5px] leading-relaxed text-ink-soft">
                    {result.community.provenance.total > 0 ? (
                      <>
                        {result.community.provenance_note} That is fewer than the{" "}
                        {result.community.min_sample} decided cases we need before
                      ...
                      <>
                        ...
                        {result.community.min_sample} have been decided, we can tell
                        you what the community is actually seeing.
                      </>
                    )}
                  </p>
                </>
                ...
                <>
                  <p className="text-[12px] font-medium text-ink">
                    From {result.community.provenance.total.toLocaleString()} shared
                    timelines · last {result.community.window_months} months
                  </p>
                  <ProvenanceLine community={result.community} />
