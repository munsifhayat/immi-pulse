...
import { AWAITING_META, dayGap, gapLabel, milestoneMeta } from "./milestone-meta";

/** The hourglass that closes an undecided timeline. */
const AwaitingIcon = AWAITING_META.Icon;
    ...
    <div className="mt-5">
      ...
      <div className="pl-0.5">
        ...
        {awaiting && (
          <div className="flex gap-3.5">
            <span
              className="relative grid h-7 w-7 shrink-0 place-items-center rounded-full text-white"
              style={{ backgroundColor: es.color }}
            >
              <span className="c-node-pulse absolute inset-0 rounded-full" />
              <AwaitingIcon className="relative h-3.5 w-3.5" strokeWidth={2} />
            </span>
            <div>
