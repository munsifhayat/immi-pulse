...
export const ROOM_NAV: RoomNavItem[] = [
  { href: "/", label: "Home", Icon: Home },
  { href: "/questions", label: "Questions", Icon: HelpCircle },
  { href: "/timelines", label: "Timelines", Icon: Waves },
...
export const ROOM_QUEUES: { id: string; code: string; label: string }[] = [
...
/** The unread badge — the reason anyone comes back to a room they posted in. */
...
export function LeftRail() {
  ...
  const { account, identity, queue, setQueue, openAccount } = useRoom();
  ...
  return (
    <div className="flex h-full flex-col">
      <Link href="/" className="flex flex-col gap-0.5 px-3 pb-6 pt-1">
        ...
        <span className="c-serif text-[14.5px] text-ink-soft">
          The Waiting Room
        </span>
      </Link>
